...
export const getI18nLanguage = (): LangKeyString => (i18n.mode === 'legacy' ? i18n.global.locale : (i18n.global.locale as unknown as WritableComputedRef<LangKeyString>).value); // 获取语言
